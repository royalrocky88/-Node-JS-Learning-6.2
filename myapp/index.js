...
//-----[1.1]----Middleware Function----------
const logger = (request, response, next) => {
  console.log(request.query);
  next();
};

//-----[4.1]----Add Middleware Authenticate Token-------------
...
//Get Books API-----[2.1]--Passing Middleware Function------
...
//User Profile API-----------[5.1]---
app.get("/profile/", authenticateToken, async (request, response, next) => {
  let { username } = request; //---Access Request Variable
